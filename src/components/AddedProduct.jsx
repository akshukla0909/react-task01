...
const AddedProduct = () => {
  ...
  const filteredProducts = products.filter(product => product.name.toLowerCase().includes(searchResults.toLowerCase()));
    ...
    <div className='mx-5 mt-5'>
      <div className='prod-list-dash'>
        ...
        <div className='prod-cards px-16'>
          ...
          <div className=''>
            {  filteredProducts.map((el, id) => (
              <div key={id} className='flex items-center justify-between mx-0 my-4 border-b border-gray-200'>
